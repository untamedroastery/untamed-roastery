...
export const MACHINES = [
  { id: "aillio-r1", brand: "Aillio", model: "Bullet R1 V2", capacity: 1000, type: "Electric Induction", tag: "1kg" },
  { id: "aillio-r2", brand: "Aillio", model: "Bullet R2 Pro", capacity: 1200, type: "Electric Induction", tag: "1.2kg" },
  { id: "kaleido-m6", brand: "Kaleido", model: "Sniper M6", capacity: 700, type: "Electric Infrared", tag: "700g" },
  { id: "probat-5", brand: "Probat", model: "Probatone 5", capacity: 5000, type: "Gas / LPG", tag: "5kg" },
  { id: "giesen-w6a", brand: "Giesen", model: "W6A", capacity: 6000, type: "Gas", tag: "6kg" },
  { id: "diedrich-ir3", brand: "Diedrich", model: "IR-3", capacity: 3000, type: "Infrared Gas", tag: "3kg" },
];
...
export const SAMPLE_ORDERS: OrderEntry[] = [
  { id: 1, client: "KNDZ Coffee", bean: "Guji G2", level: "Medium", gramsTarget: 5000, greenNeeded: 5952, machine: "Probatone 5", rounds: 2, totalTime: 46, costPerKg: 19.28, channel: "Wholesale", status: "completed", date: "2026-03-01" },
  { id: 2, client: "Bloom & Brew", bean: "Ethiopian Elto G1", level: "Light", gramsTarget: 2000, greenNeeded: 2299, machine: "Bullet R2 Pro", rounds: 2, totalTime: 28, costPerKg: 22.91, channel: "Retail", status: "in-progress", date: "2026-03-02" },
  { id: 3, client: "Espresso Bar Ltd", bean: "Kenya Ndiara FCS", level: "Med-Dark", gramsTarget: 8000, greenNeeded: 9756, machine: "W6A", rounds: 2, totalTime: 50, costPerKg: 32.16, channel: "Wholesale", status: "pending", date: "2026-03-03" },
  ...
  { id: 5, client: "Velvet Cafe", bean: "Lekempti G4", level: "Dark", gramsTarget: 10000, greenNeeded: 12500, machine: "Probatone 5", rounds: 3, totalTime: 81, costPerKg: 17.20, channel: "Wholesale", status: "delivered", date: "2026-02-25" },
